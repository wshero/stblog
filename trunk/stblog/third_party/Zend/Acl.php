 ...
 */
require_once APPPATH . 'third_part/Zend/Acl/Resource/Interface.php';


/**
 * @see Zend_Acl_Role_Registry
 */
require_once APPPATH . 'third_part/Zend/Acl/Role/Registry.php';


/**
 * @see Zend_Acl_Assert_Interface
 */
require_once APPPATH . 'third_part/Zend/Acl/Assert/Interface.php';


/**
 * @see Zend_Acl_Role
 */
require_once APPPATH . 'third_part/Zend/Acl/Role.php';


/**
 * @see Zend_Acl_Resource
 */
require_once APPPATH . 'third_part/Zend/Acl/Resource.php';
...
class Zend_Acl
{
    ...
    public function addRole($role, $parents = null)
    {
        ...
        if (!$role instanceof Zend_Acl_Role_Interface) {
            require_once APPPATH . 'third_part/Zend/Acl/Exception.php';
